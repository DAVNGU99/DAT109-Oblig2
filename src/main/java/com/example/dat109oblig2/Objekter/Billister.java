...
public class Billister {
	...
	public static List<Bil> osloBiler = List.of(
            new Bil("Model S", "Tesla", Utleiegruppe.A, "Oransje", "REG1234", 5000, true, "/images/redtesla.png"),
            new Bil("Model 3", "Tesla", Utleiegruppe.B, "Blue", "REG1235", 3000, true, "images/blaatesla.jpg"),
	...
	public static List<Bil> bergenBiler = List.of(
            ...
            new Bil("Model S", "Tesla", Utleiegruppe.B, "Oransje", "REG1241", 2000, true,"images/redtesla.png"),
            new Bil("F-150", "Ford", Utleiegruppe.B, "White", "REG1245", 5500, false,"images/whiteford.png"),
    ...
    public static List<Bil> haugesundBiler = List.of(
            new Bil("Model 3", "Tesla", Utleiegruppe.A, "Blue", "REG1251", 2300, true, "images/blaatesla.jpg"),
  ...
  public   static List<Bil> kristiansandBiler = List.of(
            ...
            new Bil("5 Series", "BMW", Utleiegruppe.C, "White", "REG1267", 6800, false, "images/5seriesbmw.png")
    );
