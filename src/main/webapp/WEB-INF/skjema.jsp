            ...
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-primary">Bergen</button>
                        <button type="button" class="btn btn-primary">Haugesund</button>
                        <button type="button" class="btn btn-primary">Kristiansand</button>
                        <button type="button" class="btn btn-primary">Oslo</button>
                        <button type="button" class="btn btn-primary">Stavanger</button>
                    </div>
                    </p>
                </div>
            </div>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 g-2">
                <div class="col">
                    <div class="card shadow-sm">
                        <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em" data-darkreader-inline-fill="" style="--darkreader-inline-fill: #dddad6;">Thumbnail</text></svg>
                        <div class="card-body">
